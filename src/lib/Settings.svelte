...
<div class="fixed z-10 inset-0  overflow-y-auto animate-fade-in">
  <div class="flex items-center  justify-center min-h-screen">
    <div class="bg-primary text-white rounded-lg shadow-xl p-8 relative">
      <button
        class="absolute top-0 right-0 mt-2 mr-2 text-gray-500 hover:text-yellow-600"
      ...
      <div class="flex justify-between items-end">
        <button
          class="bg-[#e7d2ff] hover:bg-good2 transition-colors duration-200 text-white py-2 px-4 rounded"

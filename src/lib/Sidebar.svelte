  ...
  >
    <nav class="flex h-full fle-1 flex-col space-y-1 p-2 bg-secondary">
      ...
      <div class="py-1 select-none">
        <p class="text-left font-bold px-8 text-2xl ">
          VDUTTS7 <br />
        </p>
        <p class="text-left px-8 text-xl">ChatGPT</p>
      </div>
      ...
      <button
        ...
        class="pb-8 flex border border-white/50 py-3 px-3 items-center font-bold gap-3 rounded-md hover:bg-hover transition-colors duration-200 cursor-pointer text-sm mt-auto"

<script lang="ts">
  ...
  let MSG_TYPES = {
    ...
    REPHRASE: "rephrase last message",
  };
  ...
  async function createTitle(currentInput: string) {
    ...
    let msg: ChatCompletionRequestMessage[] = [
      { role: "user", content: currentInput },
      {
        role: "user",
        content:
          "Excluding this summarization request, summarize my previous request in a natural way in 2-3 sentences.",
      },
    ];
      ...
      case MSG_TYPES.SUMMARIZE:
        ...
        outgoingMessage = [
          ...messageHistory,
          {
            role: "user",
            content:
              "Please rephrase my last message.",
          },
        ];
        console.log("Message rephrased.");
        break;
  ...
  <div class="h-screen flex flex-col md:ml-[260px] bg-secondary text-white/80">
    ...
    <div class="flex-col bg-primary">
      ...
      <div class="flex p-2 bg-primary mt-auto">
        <textarea
          class="w-full h-24 rounded p-2 mx-1 mr-0 rounded-r-none bg-chat resize-none md:resize-y focus: outline-none"
          ...
          bind:value={input}
          style="border-radius: 10px; height: 50%;"
        />
  
        <div class="flex relative">
          <button
            class="bg-chat h-16 rounded py-2 px-4 mx-1 ml-0 rounded-l-none"
            on:click={() => {
              sendMessage(MSG_TYPES.WITH_HISTORY);
            }}
          >
          ...
          <button
            class="bg-hover2 rounded h-16 min-w-[40px] mx-1 flex justify-center align-middle items-center"
            on:click={() => {
          ...
          >
            ...
            <div class="flex-col hidden sm:flex ">
              ...
              <button
                ...
                on:click={() => {
                  sendMessage(MSG_TYPES.REPHRASE);
                }}>Rephrase</button
              >
            </div>
          </div>
